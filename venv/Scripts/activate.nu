...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Dell\PycharmProjects\idflow_backend\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Dell\PycharmProjects\idflow_backend\venv\Scripts\deactivate.nu'
